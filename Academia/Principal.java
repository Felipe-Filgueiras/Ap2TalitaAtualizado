...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        try (Connection connection = connectionFactory.recuperaConexao()) {
            ...
            Cliente cliente = clienteDAO.recuperarUmClientes(1);
            System.out.println("\nCliente separado:");
            System.out.println(cliente);

            Cliente novoCliente = new Cliente(1, "BuzzLightear", "123456", "25696969", "Plano Infinito");

            clienteDAO.alterarCliente(novoCliente);
            
            System.out.println("Cliente atualizado");

            Cliente clientealterado = clienteDAO.recuperarUmClientes(1);
            System.out.println("\nCliente alterado:");
